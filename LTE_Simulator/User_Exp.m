...
%}
UEPL(1).channelOutput = awgn(UEPL(1).IFFT_data_Serial,SNR,'measured');
...
semilogy(snr(i,:) , ber(i,:));
legendValue = string(2^k) + " QAM Modulation";
legendList{1,i} = legendValue;
hold on
xlabel('SINR')
xlim([-20 15])
ylabel("BER" )
